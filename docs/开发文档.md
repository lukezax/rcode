...
│                        数据层                                │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐      │
│  │  PostgreSQL  │  │ Local Storage│  │   Swagger    │      │
│  │   (主数据库)  │  │  (文件存储)   │  │  (API 文档)  │      │
│  └──────────────┘  └──────────────┘  └──────────────┘      │
└─────────────────────────────────────────────────────────────┘
```
...
| created_by | BIGINT | 否 | - | 申请用户 ID |
| approved_by | BIGINT | 否 | - | 审批管理员 ID |
...
|------|------|------|--------|------|
| id | BIGSERIAL | 是 | 自增 | 主键 |
| referral_code_id | BIGINT | 是 | - | 邀请码 ID |
...
VALUES
    ('OpenCode', 'opencode', 'AI 编程', NULL, 'https://opencode.ai', 'AI 编程助手', TRUE, 'active'),
    ('Cursor', 'cursor', 'AI 编程', NULL, 'https://cursor.sh', 'AI 代码编辑器', TRUE, 'active'),
    -- ... 更多预置目标
;
```
